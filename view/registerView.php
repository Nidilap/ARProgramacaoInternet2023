...
<html lang="en">
  ...
  <body>
    ...
    <div class="container row-containment bg-color radius30px block-selection padding" style="margin-top: 5vh; margin-bottom: 5vh; max-width:650px;">
      ...
      <div class="row">
          ...
          <div class="col-12 col-md-6">
              <div class="input-group mb-2 txt-dark m-t-10" field="Senha">
                ...
                <input type="" class="form-control radius-0 bg-none border-none border-bottom focused validate" id="usuario-senha" name="usuario-senha" placeholder="Senha"> <!-- invalid to display wrong data input -->
              </div>
          </div>
      </div>
      <div class="row">
      <div class="col-12 col-md-6">
            <div class="input-group mb-2 txt-dark m-t-10" field="Estado">
              ...
              <input type="select" id="usuario-estado" class="hidden">
          ...
          <div class="col-12 col-md-6">
            <div class="input-group mb-2 txt-dark m-t-10" field="Cidade">
              ...
              <input type="select" name="usuario-cidade" id="usuario-cidade" class="hidden validate">
              <div class="md-select form-control radius-0 bg-none border-none border-bottom focused">
                <label>Cidade</label>
                <ul role="listbox" class="md-whiteframe-z1">
                  <?php
      ...
      <div class="row">
          ...
          <div class="col-12 col-md-6">
            <div class="input-group mb-2 txt-dark m-t-10" field="Picture">
                ...
                <input type="file" class="custom-file-input validate" id="usuario-imagem" name="usuario-imagem">
                <label id="usuario-imagem-label" class="custom-file-label form-control radius-0 bg-none border-none border-bottom focused hide-overflow" for="usuario-imagem">Picture (Choose file)</label> <!-- invalid to display wrong data input -->
            </div>
          </div>
      </div>
      <div class="row">
    ...
    <script type="text/javascript">
      ...
      function selectMenu(){
        $("#usuario-estado").siblings('.md-select').children("ul").children("li").on('click', function() {
          //apsetto del tempo per far eseguire le funzioni che inseriscono il valore del dropdown
          setTimeout(() => {
            //chiamata ajax per aggiornare le cidade
            $.post("index.php?controller=registerController&action=getEstadosRequeridos",
              ...
              function (data, status) {
                ...
                if(data!==null){
                  ...
                  //svuoto la lista
                  console.log(cidade);
                  var lista = $("#usuario-cidade").siblings('.md-select').children("ul");
                  $("#usuario-cidade").val("");
                  $("#usuario-cidade").siblings('.md-select').children("label").text("Cidade");
                  lista.empty();
